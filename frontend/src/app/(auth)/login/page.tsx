  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 lg:p-12 bg-surface-50 relative">
        ...
        >
          <span className="text-ink-900 font-semibold">Sign In</span>
          <span className="text-ink-300">|</span>
          <Link href="/signup" className="text-ink-400 hover:text-ink-700 transition-colors font-medium">
            Sign Up
          </Link>
        </motion.div>
        ...
        >
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  defaultChecked
                  className="w-4 h-4 rounded border-surface-300 text-sage-500 focus:ring-sage-400"
                />
          ...
          <p className="text-center text-sm text-ink-500 mt-5">
            ...
            <Link href="/signup" className="text-sage-500 hover:text-sage-600 font-semibold transition-colors">
              Sign Up
            </Link>
          </p>
        </motion.div>
